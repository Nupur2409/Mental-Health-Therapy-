...
class b13 extends StatefulWidget {
  ...
  @override
  State<b13> createState() => _b13State();
}

class _b13State extends State<b13> {
  bool _Play = false;
                  ...
                  Expanded(
                    ...
                    child: Column(
                      ...
                      children: [ 
                        ...
                        Row(
                          ...
                          children: [
                            ...
                            AudioWidget.assets( path: "assets/audios/8.mp3", play: _Play,
                      ...
                      print(_Play);
                            ...
                            IconButton(
                              onPressed: ()=> {
                                            Navigator.push(context, MaterialPageRoute(builder: (context) => b14()))
                                          },
