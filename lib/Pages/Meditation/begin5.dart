...
class begin5 extends StatefulWidget {
  const begin5({super.key});

  @override
  State<begin5> createState() => _begin5State();
}

class _begin5State extends State<begin5> {
  bool _Play = false;
  @override
                      ...
                      children: [
                        ...
                        Row(
                          ...
                          children: [
                            ...
                            AudioWidget.assets(
                              path: "assets/audios/First Meditation.mp3",
                              play: _Play,
                              child: IconButton(
                                icon: Icon(
