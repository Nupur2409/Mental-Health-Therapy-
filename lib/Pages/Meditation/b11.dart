...
class b11 extends StatefulWidget {
  ...
  @override
  State<b11> createState() => _b11State();
}

class _b11State extends State<b11> {
  bool _Play = false;
            ...
            child: Column(
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: Text(
                      "Two Session have been completed",
                      style: TextStyle(
                          color: Colors.black,
                  ...
                  Expanded(
                    ...
                    child: Column(
                      ...
                      children: [ 
                        ...
                        Row(
                          ...
                          children: [
                            ...
                            AudioWidget.assets( path: "assets/audios/6.mp3", play: _Play,
                      ...
                      print(_Play);
                            ...
                            IconButton(
                              onPressed: ()=> {
                                            Navigator.push(context, MaterialPageRoute(builder: (context) => b12()))
                                          },
